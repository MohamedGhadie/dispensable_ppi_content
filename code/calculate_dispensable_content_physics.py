...
# The fraction of dispensable PPIs is calculated from physics-based predictions of PPI 
# perturbations.
#
...
def main():
    ...
    dispensablePPIFile = interactomeDir / ('fraction_disp_PPIs_physics_%s%s.pkl' % (ddg_method, '_monoedgetic' if mono_edgetic else ''))
